...
[Docs](https://docs.berocket.com/plugin/woocommerce-brands?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=product_brand)
...
= 3.8.6.6 =
* Fix - Issue with shortcodes and widgets

= 3.8.6.5 =
* Enhancement - Compatibility version: Wordpress 6.9.3 and WooCommerce 10.6
* Fix - Catalog hidden products remove
* Fix - Style for brand slider
